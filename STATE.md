...
Generated: 2026-07-08T06:46:18Z from run-0019

## Now
- Target: restore Sync TB full regenerate + separate Insert wave dump (run-0015 behavior)
...
- Latest handoff: docs/handoffs/run-0019.json
- Latest review: docs/handoffs/run-0019-review.json
